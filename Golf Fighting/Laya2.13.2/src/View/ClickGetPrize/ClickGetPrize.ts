...
import { OverViewType } from "../../MyScripts/View/OverView";
/**
 * 狂点窗口使用范例如下
...
export default class ClickGetPrize extends ViewBase {
    ...
    /** @prop {name:play0, tips:"击打的时候图片0", type:Node, default:1000}*/
    public play0: Laya.Image;
    /** @prop {name:play1, tips:"击打的时候图片1", type:Node, default:1000}*/
    public play1: Laya.Image;
    /** @prop {name:getPrizeBg, tips:"得到奖励的背景", type:Node, default:1}*/
    public getPrizeBg: Laya.Box;
    ...
    OpenPrizeWindow() {
        ...
        // View_sdlyg_Mgr.instance.closeView(View_sdlyg_Def.ClickGetPrize);           
        // View_sdlyg_Mgr.instance.openView(View_sdlyg_Def.OverView,OverViewType.ClickGetPrize);    
    }
    /**
     * 误点预加载完成
     * 
