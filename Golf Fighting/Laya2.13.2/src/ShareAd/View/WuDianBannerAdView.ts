...
export default class WudianBannerAdView extends Laya.Script {
    public AdPosID: number = Share_sdlyg_Ad.BannerAdLocationID;
    ...
    onAwake() {
        ...
        Event_sdlyg_Mgr.instance.regEvemt(Event_sdlyg_Def.AD_WudianBanner_Show, this, this.ShowBanner);
        Event_sdlyg_Mgr.instance.regEvemt(Event_sdlyg_Def.AD_WudianBanner_Hide, this, this.HideBanner);
        Event_sdlyg_Mgr.instance.regEvemt(Event_sdlyg_Def.AD_WudianBanner_PreLoad, this, this.PreloadBanner);
    }
    ...
    onDestroy() {
        this.HideBanner();
        Event_sdlyg_Mgr.instance.removeEvent(Event_sdlyg_Def.AD_WudianBanner_Show, this, this.ShowBanner);
        Event_sdlyg_Mgr.instance.removeEvent(Event_sdlyg_Def.AD_WudianBanner_Hide, this, this.HideBanner);
        Event_sdlyg_Mgr.instance.removeEvent(Event_sdlyg_Def.AD_WudianBanner_PreLoad, this, this.PreloadBanner);
    }
    // onDisable(): void {
    //     this._displaySp.off(Laya.Event.CLICK, this, this.onSpClick);
    //     this.clearWXBaner();
            ...
            if (datas && datas.length > 0) {
                ...
                self._displaySp.loadImage(data.logo, Laya.Handler.create(self, function () {
                    if (!self._displaySp.destroyed) {
                        ...
                        Event_sdlyg_Mgr.instance.dispatch(Event_sdlyg_Def.AD_WudianBanner_LoadComplete);
                    }
                }));
                self._data = data;
            }
