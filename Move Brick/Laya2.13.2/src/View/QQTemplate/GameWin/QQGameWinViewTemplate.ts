...
export default class QQ_ZMDGJ_GameWinView_ZMDGJ_Template extends QQ_ZMDGJ_Template_ZMDGJ_ViewBase
{
    ...
    onStart()
    {
        ...
        if(Wu_ZMDGJ_dian_ZMDGJ_Mgr.Wu_ZMDGJ_dian_ZMDGJ_Flag && App_ZMDGJ_Config.Versions_ZMDGJ_ == App_ZMDGJ_Switch_ZMDGJ_Config.get_ZMDGJ_Instance().get_ZMDGJ_App_ZMDGJ_Switch_ZMDGJ_Data().qq_ZMDGJ_cfg.qq_ZMDGJ_versions)
        {
            ...
            if (App_ZMDGJ_Switch_ZMDGJ_Config.get_ZMDGJ_Instance().get_ZMDGJ_App_ZMDGJ_Switch_ZMDGJ_Data().qq_ZMDGJ_cfg.box == 1)  
            {
    ...
    add_ZMDGJ_Event()
    {
        ...
        this._next_ZMDGJ_Btn.on(Laya.Event.CLICK,this,this.on_ZMDGJ_Next_ZMDGJ_Btn);
    }
    ...
    remove_ZMDGJ_Event()
    {
        ...
        this._next_ZMDGJ_Btn.off(Laya.Event.CLICK,this,this.on_ZMDGJ_Next_ZMDGJ_Btn);
    }
    ...
    protected on_ZMDGJ_Next_ZMDGJ_Btn()
    {
        if(!this._click_ZMDGJ_Tag && Wu_ZMDGJ_dian_ZMDGJ_Mgr.Wu_ZMDGJ_dian_ZMDGJ_Flag)
        {
            var self = this
