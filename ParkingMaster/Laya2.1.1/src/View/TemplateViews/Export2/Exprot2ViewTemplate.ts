...
export default class Exprot2ViewTemplate extends TemplateViewBase 
{
    ...
    protected wudianEnable: boolean = false;
    ...
    onAwake()
    {
        ...
        this._continueBtn = this.View.getChildByName("ContinueBtn") as Laya.Sprite;
        this._continueBtn.visible = false;
        let self = this;
        if(WudianMgr.WudianFlag && 1 == AppSwitchConfig.getInstance().getAppSwitchData().continueBanner)
        {
    ...
    protected onContinueBtn()
    {
        if (this.wudianEnable) {
            ...
            Laya.timer.once(AppSwitchConfig.getInstance().getAppSwitchData().continueBannerShowTime * 1000,this,()=>
            {
                this.ShowBanner();
                Laya.timer.once(AppSwitchConfig.getInstance().getAppSwitchData().continueBannerHideTime * 1000,this,()=>
                {
                    this._isCanClose = true;
                    if(null != this._banner)
                    {
