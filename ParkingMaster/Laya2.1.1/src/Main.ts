...
class Main {
	...
	private preLoad()
	{
		...
		this._preLoadRes.push({ url: AppConfig.ResServer + "/json/level.json", type: Laya.Loader.JSON });
		this._preLoadRes.push({ url: AppConfig.LocalTestReServer + "/json/level.json", type: Laya.Loader.JSON });
	}
