...
export default class ryw_TTSkinTips extends ryw_TTTemplateViewBase
{
    ...
    protected ryw__skinAnchor : Laya.Clip = null;
    ...
    onAwake()
    {
        ...
        this.ryw__skinAnchor = this.ryw__centerZone.getChildByName("SkinAnchor") as Laya.Clip;
    }
