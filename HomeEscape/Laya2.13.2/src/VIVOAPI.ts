...
import ryw_GameConfig from "./GameConfig";
...
export default class VIVOAPI {
    ...
    public static tryShowNativeAd1(onSuccess : Function, onFail : Function)
    {
        ...
        {
            ryw_ViewMgr.ryw_instance.ryw_openView(ryw_ViewDef.VVNativeView1,null,(v : ryw_ViewBase)=>
            {
                success();
            });
        }
    ...
    public static tryShowNativeAd2(onSuccess : Function, onFail : Function)
    {
        ...
        if(1 == yuanshengSwitch && vivoVersions == ryw_AppConfig.ryw_Versions)
        {
            ryw_ViewMgr.ryw_instance.ryw_openView(ryw_ViewDef.VVNativeView2,null,(v : ryw_ViewBase)=>
            {
                success();
            });
        }
