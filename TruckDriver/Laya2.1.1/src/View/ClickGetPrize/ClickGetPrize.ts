 ...
 * @extends {ViewBase}
 */
export default class Click_ppxhc_GetPrize extends ViewBase {
    constructor() {
        super();
    }
     ...
     */
    BannerClicked() {
        Event_ppxhc_Mgr.instance.dispatch_(Event_ppxhc_Def.AD_WudianBanner_Hide);
        this._bannerClicked = true;
        this._clickTime = this._needClickTime;
        this._clickTime_PBar$Bar.width = this._clickBarOriginalWidth;
