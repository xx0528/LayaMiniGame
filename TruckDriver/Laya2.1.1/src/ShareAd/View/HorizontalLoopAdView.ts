...
import Loop_ppxhc_AdBox from "./LoopAdBox";

export default class Horizontal_ppxhc_LoopAdView extends Laya.Script {
    public AdPosID: number = Share_ppxhc_Ad.LoopAdLocationID_;
    ...
    protected onListRender(cell: Laya.Box, index: number): void {
        ...
        var loopAdBox: Loop_ppxhc_AdBox = cell.getComponent(Loop_ppxhc_AdBox);
