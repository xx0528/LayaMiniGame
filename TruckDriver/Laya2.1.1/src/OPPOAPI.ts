...
import OPPONativeAdView_ppxhc_Template from "./View/TemplateViews/OPPONativeAd/OPPONativeAdViewTemplate";

export default class OPPO_ppxhc_API 
{
    ...
    public static initAdService(onSuccess : Function,onFail : Function,onComplete : Function)
    {
        Laya.Browser.window["qg"].initAdService(
            {
                appId: App_ppxhc_Config.App_ppxhc_ID,
                isDebug: false,
    ...
    public static navigateToMiniProgram(pkgName: string,gameName : string, path: string, onSuccess: Function, onFail: Function, onComplate: Function) {
        if (Laya.Browser.onQGMiniGame) {
            ...
            Http_ppxhc_Unit.reportExport(pkgName,gameName,(result)=>
            {
                if(1 == result.code)
                {
            ...
            Laya.Browser.window["qg"].navigateToMiniGame(
                {
                    ...
                    path: path,
                    extraData: {
                        from : App_ppxhc_Config.App_ppxhc_ID
                    },
                    envVersion: 'release',
                    success(res) {
                        if (onSuccess) {
    ...
    public static showNativeAd(onSuccess : Function,onFail : Function)
    {
        ...
        {
            ViewMgr.instance.openView(View_ppxhc_Def.OPPONativeView,null,(v : OPPONativeAdView_ppxhc_Template)=>
            {
                if(null != onSuccess)
                {
                    onSuccess(v);
