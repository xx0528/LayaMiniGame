...
import GameContinue from "./Game/GameUI/GameContinue"
import GameHistory from "./Game/GameUI/GameHistory"
import UIStart from "./Game/GameUI/UIStart"
import GameOver from "./Game/GameUI/GameOver"
import GameSkin from "./Game/GameUI/GameSkin"
import GameView from "./Game/GameUI/GameView"
import TestGame from "./View/Game/TestGame"
import TrialSkin from "./Game/GameUI/TrialSkin"
...
export default class GameConfig{
    ...
    static init(){
        ...
        reg("Game/GameUI/GameContinue.ts",GameContinue);
        reg("Game/GameUI/GameHistory.ts",GameHistory);
        reg("Game/GameUI/UIStart.ts",UIStart);
        reg("Game/GameUI/GameOver.ts",GameOver);
        reg("Game/GameUI/GameSkin.ts",GameSkin);
        reg("Game/GameUI/GameView.ts",GameView);
        reg("View/Game/TestGame.ts",TestGame);
        reg("Game/GameUI/TrialSkin.ts",TrialSkin);
