...
export default class WXAPI_ {
    public static readonly adUnitId_ = "adunit-2b8464e79b780a23"
    public static readonly bannerAdUnitId = "adunit-c83fc9bb634048f2"
    public static readonly InsAdUnitId = "adunit-93c0c3df0866601b"
    

    public static readonly GameRecorder = new GameRecorder();

    public static wxLogin_(onSuccess: Function, onFail: Function) {
        if (Laya.Browser.onMiniGame) {
    ...
    public static showRewardedVideoAd_(onAdClose: Function, onFailed: Function) {
        if (Laya.Browser.onMiniGame) {
    ...
    //-------------------------小游戏跳转---------------------------
    public static navigateToMiniProgram_(appId: string, path: string, onSuccess: Function, onFail: Function, onComplate: Function) {
        if (Laya.Browser.onMiniGame) {
    ...
    {
        if (User_ppxhc.get_ppxhc_LeveNum() <= AppSwitchConfig.getInstance().getAppSwitchData().wxcfg.startKuangdianLevel) {
            if(onFail)
            {
                onFail();
            }
        ...
        {
            let left = WXAPI_._crazyClickShowCounter % kuangdianLevelSpcacing;
            if(0 == left)
            {
                ViewMgr.instance.openView(View_ppxhc_Def.WXCrazyClick,{
                    Complete : onComplete ,
                    titel :titel
                },(v : ViewBase)=>
                {
