...
export class WXBannder_ppxhc_Ad
{
...
export default class WXADMgr 
{
    ...
    protected static readonly _banners : Array<WXBannder_ppxhc_Ad> = new Array<any>();
    ...
    {
        let readyBannerAd :Array<WXBannder_ppxhc_Ad> = [];
        let UnreadyBannerAd :Array<WXBannder_ppxhc_Ad> = [];
    ...
    protected static _createBannerAd() : WXBannder_ppxhc_Ad
    {
        if(WXADMgr._curBannerCreateIndex >= WXADMgr._bannerIds.length)
            return null;
        let bannerAd = new WXBannder_ppxhc_Ad(WXADMgr._bannerIds[WXADMgr._curBannerCreateIndex]);
    ...
    protected static _checkBannerAd()
    {
        ...
        for(let i=0;i < WXADMgr._banners.length;++i)
        {
            let bannerAd: WXBannder_ppxhc_Ad = WXADMgr._banners[i];
