export default class Net_ppxhc_Config
{
    public static readonly state = 0;
    public static readonly gameid : number = 96;
    ...
    public static readonly reportExport = "";
    public static readonly reportImport = "";
    public static readonly getuserip = "";
    public static readonly signin = "";//签到
