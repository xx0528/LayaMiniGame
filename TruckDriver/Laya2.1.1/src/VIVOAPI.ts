...
export default class VIVOAPI {
    ...
    public static showRewardedVideoAd(onAdClose: Function, onFailed: Function) {
        if (Laya.Browser.onVVMiniGame) {
            SoundMgr.instance_.stop_ppxhc_BGM();
            ...
            Laya.Browser.window["qg"].navigateToMiniGame(
                {
                    ...
                    path: path,
                    extraData: {
                        from: App_SSPD_Config_SSPD_.App_ppxhc_ID
                    },
                    envVersion: 'release',
                    success(res) {
                        if (onSuccess) {
    ...
    public static tryShowNativeAd1(onSuccess : Function, onFail : Function)
    {
        ...
        if(1 == yuanshengSwitch && vivoVersions == AppConfig.ppxhc_Versions)
        {
            ViewMgr.instance.openView(View_ppxhc_Def.VVNativeView1,null,(v : ViewBase)=>
            {
                success();
            });
        }
    ...
    public static tryShowNativeAd2(onSuccess : Function, onFail : Function)
    {
        ...
        if(1 == yuanshengSwitch && vivoVersions == AppConfig.ppxhc_Versions)
        {
            ViewMgr.instance.openView(View_ppxhc_Def.VVNativeView2,null,(v : ViewBase)=>
            {
                success();
            });
        }
