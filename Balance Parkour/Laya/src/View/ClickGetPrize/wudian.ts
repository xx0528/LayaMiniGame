...
export default class ClickGetPrize extends ViewBase {
    ...
    private _bannerClickTime: number = 4;//点多少次开始显示bannerr套路用户，可微调    
    ...
    private drgon: Laya.Skeleton
    // private _wudianLoadFlag: boolean;
    onAwake() {
        // Event_tippy_Mgr.ins_tippy_tance.dispatch(Event_tippy_Def.AD_CloseBanner, true)
        // this.drgon = this.owner.getChildByName("panch") as Laya.Skeleton
        // console.log(this.drgon);
    ...
    onUpdate() {
        /* 箭头上下移动 */
        // if (this._arrowUp) {
        //     this._click_Btn.scaleX += Laya.timer.delta / 500;
        //     this._click_Btn.scaleY += Laya.timer.delta / 500;
        //     if (this._click_Btn.scaleX > 1.3) {
        //         this._arrowUp = false;
        //     }
        // }
        // else {
