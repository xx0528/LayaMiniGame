...
export default class CachedWXBannerAd {
    ...
    public static preloadBanner() {
        var wxWuDianBanners = AppSwitchConfig.get_tippy_Instance().getAppSwitchData().wxWuDianBanners;
        var bannerTodayBannerMax = AppSwitchConfig.get_tippy_Instance().getAppSwitchData().bannerTodayBannerMax;
    ...
    public static show() {
        ...
        var wuDianBanners = AppSwitchConfig.get_tippy_Instance().getAppSwitchData().wxWuDianBanners;
        ...
        var time = AppSwitchConfig.get_tippy_Instance().getAppSwitchData().bannerFreshTimer;
