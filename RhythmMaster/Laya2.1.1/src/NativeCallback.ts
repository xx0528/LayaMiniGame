...
export default class NativeCallback {
    ...
    public static onVideoFail() {
        Event_myqq_Mgr.instance.dispatch(EventDef.RewardVideoFail);
        Laya.SoundManager.muted = false;
    }

    public static onVideoSuccess(reward:string) {
        Event_myqq_Mgr.instance.dispatch(EventDef.RewardVideoSuccess, reward);
        Laya.SoundManager.muted = false;
    }

    public static onInsertVideoEnd() {
        console.debug("onInsertVideoEnd    --------- ------------ ");
        Event_myqq_Mgr.instance.dispatch(EventDef.InsertVideoEnd);
    }
