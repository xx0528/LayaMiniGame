import Banner_myqq_AdView from "../../ShareAd/View/BannerAdView";
...
export default class UniversalBottomZone extends Laya.Script 
{
    ...
    protected _bannerAd : Banner_myqq_AdView;
    ...
    onAwake()
    {
        ...
        this._bannerAd = this._bannerADZone.getComponent(Banner_myqq_AdView);
    }
