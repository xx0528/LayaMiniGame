...
export default class ViewBase extends Laya.Script 
{
    ...
    public openView(data?: any): void {
        this._data = data;
        this.show()
        Event_myqq_Mgr.instance.dispatch(EventDef.Game_OnViewOpen,{view:this._viewDef})
        if(this.onOpenEvent)
        {
            this.onOpenEvent();
        }
    ...
    public closeView() 
    {
        View_myqq_Mgr.instance.closeView(this._viewDef);
    }
    ...
    protected onClose()
    {
        ...
        Event_myqq_Mgr.instance.dispatch(EventDef.Game_OnViewClose,{view:this._viewDef})
