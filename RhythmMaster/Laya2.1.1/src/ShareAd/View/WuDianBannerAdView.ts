...
export default class WudianBannerAdView extends Laya.Script {
    ...
    onAwake() {
        ...
        Event_myqq_Mgr.instance.regEvemt(EventDef.AD_WudianBanner_Show, this, this.ShowBanner);
        Event_myqq_Mgr.instance.regEvemt(EventDef.AD_WudianBanner_Hide, this, this.HideBanner);
        Event_myqq_Mgr.instance.regEvemt(EventDef.AD_WudianBanner_PreLoad, this, this.PreloadBanner);
    }
    ...
    onDestroy() {
        this.HideBanner();
        Event_myqq_Mgr.instance.removeEvent(EventDef.AD_WudianBanner_Show, this, this.ShowBanner);
        Event_myqq_Mgr.instance.removeEvent(EventDef.AD_WudianBanner_Hide, this, this.HideBanner);
        Event_myqq_Mgr.instance.removeEvent(EventDef.AD_WudianBanner_PreLoad, this, this.PreloadBanner);
    }
    // onDisable(): void {
    //     this._displaySp.off(Laya.Event.CLICK, this, this.onSpClick);
    //     this.clearWXBaner();
            ...
            if (datas && datas.length > 0) {
                ...
                self._displaySp.loadImage(data.logo, Laya.Handler.create(self, function () {
                    if (!self._displaySp.destroyed) {
                        ...
                        Event_myqq_Mgr.instance.dispatch(EventDef.AD_WudianBanner_LoadComplete);
                    }
                }));
                self._data = data;
            }
