...
export default class ClickGetPrize extends ViewBase {
    ...
    onAwake() {
        ...
        Even_JJKLBB_tMgr.insta_JJKLBB_nce.regO_JJKLBB_nceEvent(Event_JJKLBB_Def.AD_Wudia_JJKLBB_nBanner_Load_JJKLBB_Complete, this, this.WudianLoadComplete);
    }
    ...
    ShowBanner() {
        ...
        Even_JJKLBB_tMgr.insta_JJKLBB_nce.dispa_JJKLBB_tch(Event_JJKLBB_Def.AD_Wudi_JJKLBB_anBanner_Show);
    }
    /**
     * 狂点按钮逻辑
     * 
     ...
     */
    BannerClicked() {
        Even_JJKLBB_tMgr.insta_JJKLBB_nce.dispa_JJKLBB_tch(Event_JJKLBB_Def.AD_Wudi_JJKLBB_anB_JJKLBB_anner_Hide);
        this._bannerClicked = true;
        this._clickTime = this._needClickTime;
        this._clickTime_PBar$Bar.width = this._clickBarOriginalWidth;
