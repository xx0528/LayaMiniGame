...
export default class ViewBase extends Laya.Script 
{
    ...
    protected _viewDef : View_JJKLBB_Def = View_JJKLBB_Def.None;
    protected _data : any = {};
    ...
    public openView(data?: any): void {
        this._data = data;
        this.show()
        Even_JJKLBB_tMgr.insta_JJKLBB_nce.dispa_JJKLBB_tch(Event_JJKLBB_Def.Game_OnVie_JJKLBB_wOpen,{view:this._viewDef})
        if(this.onOpenEvent)
        {
            this.onOpenEvent();
        }
    ...
    public closeView() 
    {
        View_JJKLBB_Mgr.insta_JJKLBB_nce.closeView(this._viewDef);
    }
    ...
    protected onClose()
    {
        ...
        Even_JJKLBB_tMgr.insta_JJKLBB_nce.dispa_JJKLBB_tch(Event_JJKLBB_Def.Game_OnVie_JJKLBB_wClose,{view:this._viewDef})
