...
export default class QQ_wcjtn_Game_wcjtn_FailViewTemplate extends QQ_wcjtn_Template_wcjtn_ViewBase
{
    ...
    onStart()
    {
        ...
        if(Wu_wcjtn_dian_wcjtn_Mgr.Wu_wcjtn_dian_wcjtn_Flag && App_wcjtn_Config.Versions_wcjtn_ == App_wcjtn_Switch_wcjtn_Config.get_wcjtn_Instance().get_wcjtn_App_wcjtn_Switch_wcjtn_Data().qq_wcjtn_cfg.qq_wcjtn_versions)
        {
            ...
            if (1 == App_wcjtn_Switch_wcjtn_Config.get_wcjtn_Instance().get_wcjtn_App_wcjtn_Switch_wcjtn_Data().qq_wcjtn_cfg.box)  {
